...
::: {.column width="40%"}
![risk1_pis.png](ai_society_images\risk1_pis.png)\    
...
::: {.column width="40%"}
![1_week_lapse_no_lapse.png](ai_society_images\1_week_lapse_no_lapse.png)\ 
:::
::::
::: {.notes}
...
::: {.column width="40%"}
![1_week_lapse_no_lapse_threshold.png](ai_society_images\1_week_lapse_no_lapse_threshold.png)\ 
:::
...
![metrics_1_week.png](ai_society_images\metrics_1_week.png){width=85%}\
...
::: {.column width="50%"}
![roc_1_week.png](ai_society_images\roc_1_week.png)\ 
:::
...
::: {.column width="50%"}
![features_1_week.png](ai_society_images\features_1_week.png)\ 
:::
...
::: {.column width="50%"}
![roc_1_day.png](ai_society_images\roc_1_day.png)\ 
:::
::::
...
![metrics_1_day.png](ai_society_images\metrics_1_day.png){width=85%}\
...
::: {.column width="50%"}
![features_1_day.png](ai_society_images\features_1_day.png)\ 
:::
...
::: {.column width="50%"}
![roc_1_hour.png](ai_society_images\roc_1_hour.png)\ 
:::
::::
...
![metrics_1_hour.png](ai_society_images\metrics_1_hour.png){width=85%}\
...
::: {.column width="50%"}
![features_1_hour.png](ai_society_images\features_1_hour.png)\ 
:::
...
![metrics_ppv.png](ai_society_images\metrics_ppv.png){width=85%}\
...
![metrics_lapse_frequency.png](ai_society_images\metrics_lapse_frequency.png){width=85%}\
...
![metrics_lapse_frequency_PPV.png](ai_society_images\metrics_lapse_frequency_PPV.png){width=85%}\
...
::: {.column width="50%"}
![recall_curves_graph.png](ai_society_images\recall_curves_graph.png)\ 
:::
...
JOHN this page is blank in the original PPT but the notes are unique to this page.
...
![context_gps.png](ai_society_images\context_gps.png){width="75%"}\ 
...
![context_cell.png](ai_society_images\context_cell.png){width="75%"}\ 
...
:::
::: {.column width="50%"}
![feature_gps.png](ai_society_images\feature_gps.png)\ 
:::
::::
...
::: {.column width="60%"}
![risk2_pis.png](ai_society_images\risk2_pis.png)\ 
:::
::: {.column width="40%"}
...
![relapse_prevention_flowchart.png](ai_society_images\relapse_prevention_flowchart.png){.absolute bottom="0%" left="10%" width="73%" height="auto"}\ 
...
![credits.png](ai_society_images\credits.png){.absolute bottom="0%" left="5%" width="92%" height="auto"}\ 
...
![ema_compliance.png](ai_society_images\ema_compliance.png){.absolute bottom="0%" left="25%" width="50%" height="auto"}\ 
...
::: {.column}
![ema_interfere.png](ai_society_images\ema_interfere.png){width="50%" height="auto"}\ 

![ema_dislike.png](ai_society_images\ema_dislike.png){width="50%" height="auto"}\ 
:::

::: {.column}

![ema_4x_year.png](ai_society_images\ema_4x_year.png){width="50%" height="auto"}\ 

![ema_1x_year.png](ai_society_images\ema_1x_year.png){width="50%" height="auto"}\ 
:::
...
:::
::: {.column width="60%"}
![confusion_1_week.png](ai_society_images\confusion_1_week.png){width=75%}\
:::
::::
...
:::
::: {.column width="60%"}
![confusion_1_day.png](ai_society_images\confusion_1_day.png){width=75%}\
:::
::::
...
:::
::: {.column width="60%"}
![confusion_1_hour.png](ai_society_images\confusion_1_hour.png){width=75%}\
:::
::::
