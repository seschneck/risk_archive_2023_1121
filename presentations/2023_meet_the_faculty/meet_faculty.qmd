...
:::
## {#beta_app data-menu-title="Image of beta app" background-image="images\beta_app.png" background-size="100%" background-repeat="none"}
...
::: {.column width="40%"}
![1_week_lapse_no_lapse_threshold.png](images\1_week_lapse_no_lapse_threshold.png)\ 
:::
...
::: {.column width="50%"}
![roc_1_week.png](images\roc_1_week.png)\ 
:::
...
::: {.column width="50%"}
![features_1_week.png](images\features_1_week.png)\ 
:::
...
::: {.column width="50%"}
![roc_1_day.png](images\roc_1_day.png)\ 
:::
::::
...
::: {.column width="50%"}
![features_1_day.png](images\features_1_day.png)\ 
:::
...
::: {.column width="50%"}
![roc_1_hour.png](images\roc_1_hour.png)\ 
:::
::::
...
::: {.column width="50%"}
![features_1_hour.png](images\features_1_hour.png)\ 
:::
...
::: {.column width="50%"}
![threshold_.5_graph.png](images\threshold_.5_graph.png){width=80%}\ 
:::
...
::: {.column width="50%"}
![threshold_.9_graph.png](images\threshold_.9_graph.png){width=80%}\ 
:::
...
::: {.column width="50%"}
![recall_curves_graph.png](images\recall_curves_graph.png)\ 
:::
...
## {#gps_detection_1 data-menu-title="GPS detection, wide view" background-image="images\john_gps_wide.png" background-size="100%" background-position="bottom" background-repeat="none"}
...
## {#gps_detection_2 data-menu-title="GPS detection, zoomed" background-image="images\john_gps_zoom.png" background-size="100%" background-position="bottom" background-repeat="none"}
