...
results_aggregate %>% 
  ...
  select(algorithm, `feature set` = feature_set, `feature type` = feature_fun_type, resample, 
...
results_best_model %>% 
  ...
  kbl(booktabs = TRUE,
      digits = 2,
      caption = "Classification Performance Metrics for Best Model across 100 Folds") %>% 
  kable_styling() 
```
