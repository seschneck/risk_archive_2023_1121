...
Figure 10. Histogram of best active (glmnet) and passive (random forest) model configuration balanced accuracies across 100 folds. 
...
- Use partial plots to determine which direction a feature is predicting for our top features
