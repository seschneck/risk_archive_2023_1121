...
tibble(Prediction = c("no", "yes"),
    ...
    apa_table(placement = "pt",
              ...
              note = "The best model configuration was XXXXX.     
              Results based on grouped 10x10-fold cross validation.")
...
results_best_model %>% 
  ...
  apa_table(placement = "pt", digits = 2, 
            ...
            note = "The best model configuration was XXXXX.     
              Performance estimated by grouped 10x10-fold cross validation.")
# KENDRA add full description of this configuration to this note
...
Figure 2. Histogram of best active (glmnet) and passive (random forest) model fits across 100 folds. 
...
Figure 3. Model comparison of the best active (glmnet) and best passive (random forest) models.
