...
<!-- KW: I removed the part about justifying sample size and completing the checklist. Everything else is on OSF except for the version of the manuscript that shows the code to serve as annotated results -->
...
We conducted a permutation test of feature importance to see which features contributed most to our top performing model configuration (passive random forest). Figure 10 shows which features when removed from the model configuration had the greatest effect on performance. 
