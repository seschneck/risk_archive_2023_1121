...
```{r}
filter_features <- function(subid, hour, data, lead_hours, period_duration_hours, study_start = NULL) {
  ...
  # can remove message - just for demo
...
With period duration hours specified
```{r}
