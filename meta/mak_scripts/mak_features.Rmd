...
Incoming/Outcoming calls from Drinkers
```{r}
meta_features <- meta_features %>% 
  full_join(map2_dfr(labels_05$subid, 
         ...
         score_ratecount_value,
            ...
            context_value = "Drinker"), by = c("subid", "dttm_label"))
```
...
**FIX: don't rename outcome variable to Y - handled in recipe**
