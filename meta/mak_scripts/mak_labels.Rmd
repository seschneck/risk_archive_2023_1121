...
Get valid lapse and no_lapse observations by specified time frame (in hours)

* tibble includes all hour intervals for each subject starting on midnight on day 2 through
...
These periods are excluded if there are within +-24 hours of a valid lapse period, or similar
