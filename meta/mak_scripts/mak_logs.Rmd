...
```{r}
logs <- logs %>% 
  rename(drank_w_contact_in_past = contact_drank_past,
         drinker_status = drink_status,
         contact_will_drink_in_presence = contact_drink_future,
         recovery_status = recovery,
         supportiveness = support_status,
         experience_w_contact = contact_experience,
         visited_monthly = monthly_visit) %>% 
  mutate(contact_type = case_when(contact_type == "Aunt/Uncle" ~ "aunt_uncle",
                                  ...
                                  TRUE ~ contact_type),
         drank_w_contact_in_past = case_when(drank_w_contact_in_past == "Almost Always/Always" ~ "always_almost_always",
                                             drank_w_contact_in_past == "Never/Almost Never" ~ "never_almost_never",
                                             drank_w_contact_in_past == "Occasionally" ~ "occasionally",
                                             TRUE ~ drank_w_contact_in_past),
         drinker_status = case_when(drinker_status == "Dont Know" ~ "dont_know",
                                    drinker_status == "Drinker" ~ "drinker",
                                    drinker_status == "Nondrinker" ~ "nondrinker",
                                    TRUE ~ drinker_status),
         contact_will_drink_in_presence = case_when(contact_will_drink_in_presence == "No" ~ "no",
                                                    contact_will_drink_in_presence == "Uncertain" ~ "uncertain",
                                                    contact_will_drink_in_presence == "Yes" ~ "yes",
                                                    TRUE ~ contact_will_drink_in_presence),
         recovery_status = case_when(recovery_status == "Dont Know" ~ "dont_know",
                                     recovery_status == "No" ~ "no",
                                     recovery_status == "Yes" ~ "yes",
                                     TRUE ~ recovery_status),
         supportiveness = case_when(supportiveness == "Dont Know" ~ "dont_know",
                                    ...
                                    TRUE ~ supportiveness),
         experience_w_contact = case_when(experience_w_contact == "Mixed" ~ "mixed",
                                          experience_w_contact == "Neutral" ~ "neutral",
                                          experience_w_contact == "Pleasant" ~ "pleasant",
                                          experience_w_contact == "Unpleasant" ~ "unpleasant",
                                          TRUE ~ experience_w_contact),
         visited_monthly = case_when(visited_monthly == "No" ~ "no",
                                     visited_monthly == "Yes" ~ "yes",
                                     TRUE ~ visited_monthly))
```
