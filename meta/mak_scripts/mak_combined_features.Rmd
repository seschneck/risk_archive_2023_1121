...
# features %>% 
#   saveRDS(here(path_meta, str_c("features_", window, ".rds.xz")), compress = "xz")
```
...
features_reduced <- features %>% 
  select(-contains("pratesum")) %>% 
  select(-contains("pratecount")) %>%
  select(-contains("ppropcount"))

features_reduced %>% 
  saveRDS(here(path_meta, str_c("features_", window, "_reduced.rds.xz")), compress = "xz")
