...
These labels are complete. See conclusions for important points that may affect study-level 
decisions.   
...
NOTE: These may be unreliable lapses - should consider whether to include
```{r}
ema_all %>% 
