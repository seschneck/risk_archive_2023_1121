...
- Make midnight date correction for negative lapses with end time at 1 or 2 AM?   
...
- We decided we will retain 128's data even though they have over 100 lapses for the following reasons:   
...
- Subid 118 has an invalid end time (None12pm) left in cleaned EMA as study-level decision. After KW 
and JC reviewed this situation, it was concluded that it was likely they were still drinking at time 
...
All lapses from unfinished surveys have complete dates and times   
```{r}
ema %>% 
  filter(finished == 0) %>% 
  select(subid, ema_1_1:ema_1_4)
