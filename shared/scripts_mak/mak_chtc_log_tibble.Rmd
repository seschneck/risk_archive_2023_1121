...
jobs_path <- "P:/studydata/risk/chtc/meta/train_1day_0_v2_glmnet/input/jobs.csv"
```
...
Read in jobs
```{r}
jobs <- vroom(here(jobs_path), col_types = vroom::cols())
```
...
<!-- get run time by algorithm and resample -->
