...
switch (Sys.info()[['sysname']],
        # PC paths
        Windows = {
          path_jobs <- str_c("P:/studydata/risk/chtc/", data_type, "/features_", window, "_", lead, "_", version)
          path_processed <- str_c("P:/studydata/risk/data_processed/", data_type)},

        # IOS paths
        Darwin = {
          path_jobs <- str_c("/Volumes/private/studydata/risk/chtc/", data_type, "/features_", window, "_", lead, "_", version)
