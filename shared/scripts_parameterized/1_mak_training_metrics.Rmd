...
```{r}
metrics_raw_all %>% 
  write_csv(file.path(path_processed, str_c("metrics_raw_train_", data_type, "_", window, "_", lead, "_", version, "_", cv, ".csv")))
```
