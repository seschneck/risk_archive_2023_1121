---
title: "Combines training jobs from CHTC for `r params$window` window and `r params$lead` lead and `r params$version`"
...
for (batch_name in batch_names) {
  ...
  metrics_raw_batch <- results_files %>% 
    future_map_dfr(\(fn) read_csv(fn, col_types = cols()))
...
Foreshadow performance.  These are simple kfold evaluations
```{r}
