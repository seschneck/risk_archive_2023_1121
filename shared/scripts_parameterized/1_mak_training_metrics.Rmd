...
for (batch_name in batch_names) {
  ...
  # read in configs
  configs <- read_csv(file.path(path_input, batch_name, "input", "configs.csv"), show_col_types = FALSE)
  (n_configs <- nrow(configs))
  
  # read in results
  results_batch <- read_csv(file.path(path_input, batch_name, "output", "results_batch.csv"), show_col_types = FALSE)
