...
if (str_detect(algorithms, "all") || str_detect(algorithms, "xgboost")) {
  ...
  # FIX: NESTED CURRENTLY WILL OVERWRITE NON-NESTED XGBOOST
  # add if statement to detect "nested" in algorithm
  (batch_name <- str_c("train_", data_type, "_", window, "_", lead, "_", version, "_xgboost"))
