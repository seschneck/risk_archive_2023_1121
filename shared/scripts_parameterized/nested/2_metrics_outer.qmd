...
fit_predict_eval <- function(split_num, splits, configs_best){
  ...
  write_csv(tibble(outer_split_num = split_num, start_time = Sys.time(), end_time = NA),
  ...
  # delete this file when script is complete.  
  # Don't commit to repo!
  write_csv(tibble(outer_split_num = split_num, start_time = NA, end_time = Sys.time()),
            str_c("tmp_metrics_outer_progress_", window),
            append = TRUE)
