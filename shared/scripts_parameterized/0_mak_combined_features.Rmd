...
```{r save_features}
# NEED TO UPDATE THIS AT SOME POINT TO USE write_csv() rather than vroom_write
# AND TO MAKE IT A CSV FILE.
features %>% 
  vroom_write(here(path_processed, str_c("features_", data_type, "_", window, "_", lead, "_", version, ".tsv.xz")))
```