...
**Start and end times all have accurate dates. No obvious timing errors but there is variation in time taken to complete survey. Will want to further explore timing component of start and end date variables if using these in your study.**    
...
- 7 subids look particularly problematic with more than a 2 hour time difference.  
