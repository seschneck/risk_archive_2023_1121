...
```{r}
session_1 <- read_csv(here(path_in, "session_followup_3_v1.csv")) %>%
  rename(subid = SSFU3_3, response_id = ResponseID) %>% 
  glimpse()
session_2 <- read_csv(here(path_in, "session_followup_3_v2.csv")) %>% 
  rename(subid = SSFU3_3, response_id = ResponseID) %>% 
  glimpse()
session_3 <- read_csv(here(path_in, "session_followup_3_v3.csv")) %>% 
  rename(subid = SSFU3_3, response_id = ResponseID) %>% 
  glimpse()
session_4 <- read_csv(here(path_in, "session_followup_3_v4.csv")) %>% 
  rename(subid = SSFU3_3, response_id = ResponseID) %>% 
  glimpse()
```
...
```{r}
log_1 <- read_csv(here(path_log, "log_session_followup_3_v1.csv"))  %>% 
