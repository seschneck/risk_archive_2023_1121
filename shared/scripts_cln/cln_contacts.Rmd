...
clean_contacts <- function(d, log){
  ...
  # recode_all entries
  # Changing typos in variable response labels
...
FIX: subid 39 has 81 entries for number 8008436154 - several entries for this number on multiple visits  
how is this possible?
```{r}
contacts %>% 
  filter(subid == 39 & phone_number == "8008436154") %>% 
  kbl() %>% 
