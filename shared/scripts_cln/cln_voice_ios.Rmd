...
*Note that many variables have 1040 missing values. These missing values are a result of some log entries at the end being in csv format instead of sql and having limited information/variables to work with.*    
