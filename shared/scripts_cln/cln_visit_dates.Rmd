...
* All subids who completed screen session have an entry in visit dates.    
* Many end study dates were imputed for passively discontinued participants (the process for how these decisions were reached are all documented in the end study EDA section of this script).   
...
* followup_12.csv      
* followup_3.csv        
* raw_notes.csv    (This file was renamed to notes_raw.csv)
* gcal_risk.ics      
