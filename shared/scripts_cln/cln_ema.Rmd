...
- Check how to handle tz and recode_tz log entries    
- Check how many days between EMAs (large gaps?)    
- Check subid 269's data with 10-15 surveys on some days    
- Check if participants without lapses are missing EMAs     
- Look at surveys completed in under 12 seconds    
- Flag 5 lapses reported in under 30 seconds    
...
*FIX: confirm tz is recoded and handled properly in r*
