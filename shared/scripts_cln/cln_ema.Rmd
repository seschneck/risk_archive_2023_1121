...
- Discuss 30 lapses where the start date and time are identical to another entry but the end date or time is not the same - log notes add some explanation.   
