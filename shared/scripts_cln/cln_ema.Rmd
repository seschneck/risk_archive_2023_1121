...
Lapse dates recoded to correct format of date, remove incorrect lapse information to line up with recoded lapses or correct known errors from data log
```{r}
log_all %>% 
