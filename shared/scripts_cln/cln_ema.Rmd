...
- flagged EMA log entries in flagged_entries.Rmd    
- how to handle surveys taken within minutes of each other (i.e., incomplete followed by complete survey)   
...
- Notes on validity of lapse labels are in this script
