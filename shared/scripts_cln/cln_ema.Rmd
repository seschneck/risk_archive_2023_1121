...
- Check how to handle tz and recode_tz entries    
- check and remove test entries   
- Check how many days between EMAs (large gaps?) and validity of lapses (duration)     
...
- Subids 104 and 128 have over 100 reported lapses. According to notes, subid 104 reported lapses everyday on study.    
...
Duration of lapses   
*FIX: How to check timezone participant was in? (should all be in America/Chicago)*   
