...
Data are almost fully cleaned (see outstanding fix below). EDA on all variables.   

Outstanding fix:   

* More EDA needed on time component of start and end date. This may not be necessary since these are session forms (treated as notes). Still, I have done light EDA on time. However, if you plan to use these variables as data in your study you will want to further explore them.   
