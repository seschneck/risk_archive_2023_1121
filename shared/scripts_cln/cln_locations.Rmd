...
Note the following typos in addresses, with the assumed correct names listed second:
...
Note that some listed places may refer to a single location (e.g., a large workplace campus), and other listed places were not necessarily visited by participants. 
