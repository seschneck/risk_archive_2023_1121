...
* Check/handle non-identical duplicates (KW working on this)    
...
all_logs %>% 
  ...
  distinct(., across(c(subid, address, date, type, body, read, status, locked,
                       date_sent, contact_name)), .keep_all = TRUE) %>% glimpse()
