# NOTE: this function was pulled from the plotKML pacakge because that package was pulled from CRAN
# It is sourced by cln_gps.Rmd to process the MOVES gpx files
