...
* entertainment -- bar, restaurant (some from "other" fit here)

* public/community spaces -- coffee shop/cafe, church, park, volunteer (from "other", library)

* recovery and health -- aa/recovery meeting, health care, gym/fitness center

* errands (many from "other" fit here)

* work/school

* travel stop (many from "other" fit here: bus stop, airport)
