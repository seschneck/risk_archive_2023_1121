...
* There are duplicate rows in the locations data. Reduce to unique rows.
* In the locations data, rows may refer to the same place despite having different lat/long
* Many people seem to travel in-town for work
* We should impute type labels for one "NA" and for several "others"
* Categories for labels could be
