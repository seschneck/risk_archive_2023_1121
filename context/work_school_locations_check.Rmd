...
location_descriptions <- read_csv(
  "./context/user_locations_check.csv",
...
#checking dropped subjects
locations %>% group_by(subid) %>% count() %>% nrow()
...
location_check %>% 
  select(-gps_data) %>% 
  write_delim("P:/studydata/risk/data_processed/context/location_check.csv", delim = ",")
...
=======
  write_delim("P:/studydata/risk/data_processed/context/locations_other_imputed.csv", delim = ",")
>>>>>>> Stashed changes
...
gps %>% 
  write_delim("P:/studydata/risk/data_processed/context/gps_with_exclusions.csv", delim = ",")
...
vroom("P:/studydata/risk/data_processed/context/gps_with_exclusions.csv") %>% 
  group_by(subid) %>% 
  count() %>% 
  nrow()

vroom("P:/studydata/risk/data_processed/context/location_check.csv") %>% 
  group_by(subid) %>% 
  count() %>% 
  nrow()  

vroom("P:/studydata/risk/data_processed/context/locations_other_imputed.csv") %>% 
  group_by(subid) %>% 
  count() %>% 
  nrow()  
```
