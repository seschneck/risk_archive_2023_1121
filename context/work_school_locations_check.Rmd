...
- It might be worth formalizing exclusion criteria for each labeled place... like people must have visited each place X number of times (defined by an observation within a particular distance) to be included in analyses.
