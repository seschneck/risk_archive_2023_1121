...
Notes:
1. There is something odd going on with the number of digits in latitude and longitude. It might be an Excel issue, although the fact that it is happening with the GPS data suggests that it is not.
2. There are duplicate locations (i.e., locations with the same subid, lat, and long).
