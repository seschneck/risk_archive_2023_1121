...
Combines the morning and later ema files from shared folder and saves in processed data for lag study.  This is essentially the same code as for the ema study with minor updates for new lab conventions (including change to qmd)
