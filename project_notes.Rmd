...
## Excluded Participants when Lapse is Outcome

This is based on label label EDA performed by Kendra.  We will drop, 104, 269, 204.  We decided to retain 128 (see notes below)
...
* Had extremely poor compliance. 33 out of 89 study days had an EMA completed. They only did a total of 5 surveys between followup 2 and 3.
...
* From notes - “Participant did not do many surveys during their second month of participation. At their Follow-up 2 visit they reported several lapses that were not documented in their EMAs - estimated lapse days/times in subid’s raw data log.”  JC note: “There are issues with 204. They are missing lapses reported by interview. But they also stopped doing any ema by 5/17 even though their study end date was 6/13. Probably need to drop them for lapse analyses for anything after 5/17. Probably also need to add in their reported lapses at follow-up 2. OR we drop them at the end of follow-up 1 or wherever their ema gets sketchy”


John and Kendra decided to retain 128
