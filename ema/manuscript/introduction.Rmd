...
-->
<!--JJC - Editted to follow Strunk and White by ChatGPT!  Seems much crisper to me.   The cites of increased hospitalizations, etc seem dated.  -->
<!--Alcohol Use Disorder (AUD) is a prevalent, costly, and relapsing disease that poses numerous treatment challenges. Approximately 14.5 million adults in the United States met the criteria for AUD in the past year. The consequences of AUD include serious health and safety issues for individuals and significant societal costs, such as increased crime rates and healthcare spending. Over 140,000 deaths in the US each year are alcohol-related, and alcohol-related hospitalizations rose by 47% between 2010 and 2014, underscoring the growing public health risk associated with AUD. However, only 13% of individuals with AUD seek treatment, with stigma, cost, burden, and limited availability imposing significant barriers.
-->

Even for those who do obtain treatment, the complex and relapsing nature of AUD results in a difficult treatment process. This complexity is modeled by contemporary relapse prevention models of substance use treatment that stress the individualized, dynamic, and context dependent nature of relapse events which requires tailored treatment and sustained efforts towards personal wellness on the the part of the individual.  Individuals in treatment for AUD tend to relapse often and unexpectedly requiring life long monitoring. While contemporary relapse prevention and biopsychosocial models of substance use treatment acknowledge the ongoing complexity associated with relapse, the burden of monitoring this complexity has typically fallen on the individual receiving treatment. Previous research has identified that individuals with AUD  are often unable to recognize when states risk or opportunity for intervention emerge, and fail to initiate the type of support needed to address these states in a timely manner. While relapse prevention techniques have been effective at identifying the utility of different skill sets for different relapse situations, the effort of self-monitoring for increased risky situations during which to use these interventions is left to the individual, creating frequent opportunities for relapse in the recovery process.

<!--For those who obtain treatment, AUD's complex and relapsing nature complicates the process. Contemporary relapse prevention models emphasize the individualized, dynamic, and context-dependent nature of relapse events, necessitating tailored treatment and sustained personal wellness efforts. Individuals in AUD treatment often relapse unpredictably and require lifelong monitoring. While current models acknowledge relapse complexity, the monitoring burden typically falls on the individual. Research indicates that individuals with AUD often struggle to recognize high-risk states or opportunities for intervention and may not initiate the necessary support in a timely manner. Though relapse prevention techniques identify various skill sets for different situations, individuals must still self-monitor for high-risk situations, creating frequent relapse opportunities during recovery.-->

Digital therapeutics hold potential to address issues of AUD treatment accessibility and complexity. Broadly, digital therapeutics refers to a treatment framework utilizing mobile health technology (e.g. smartphones, wearable devices) to deliver mental health interventions in a low cost, scalable manner. Digital therapeutics can address many barriers related to low levels of treatment seeking in individuals with AUD due to the low burden on the part of the participant to access treatment on a digital platform. Emerging digital therapeutics have been successful in reducing substance use disorder related outcomes, including increased abstinence levels, decreased heavy drinking days, and increased retention in treatment programs among individuals in treatment for alcohol, marijuana, cocaine, and polysubstance use. Previous work has demonstrated the acceptability of mobile health interventions among individuals with substance use disorders, and multiple studies have assessed their efficacy in populations that are typically difficulty to engage in treatment for AUD (e.g. rural communities, homeless populations). <!--GEF: i think this paragraph can be shortened a lot - its main purpose (from my understanding) in the intro is to set the scene for digital therapeutics as a sensing and monitoring platform. more details can happen about opportunities for treatment in the discussion -->
<!--KW: I think this paragraph could be removed-->
<!--JJC: I agree with GEF & KW.  The focus of this and other later paragraphs is too far from our study to set it up well.   You can make the points that sensing can be used to monitor lapse risk, sensing can be implemented in digital therapeutics and digital therapeutics can benefit from algorithms that use sensed data to time, recommend or adapt interventions.  But the focus needs to stay on the development of algorithms, not on the digital therapeutics-->

Digital therapeutics also offer a platform to address the complexity of AUD treatment to remove burden from the individual during the treatment process<!--JJC: not clear how digital therapeutics address complexity-->. Less work has examined the ability for digital therapeutics to increase treatment efficacy by tailoring interventions to the complex nature of AUD. Calls for development of just-in-time  adaptive interventions (JITAIS) <!--GEF: i know you were excited about the JITAI terminology. personally i find it distracting (at least in the intro) given that this project is several steps away from JITAI development. maybe good to bring in during the discussion? -->within digital therapeutics for substance use disorder have identified this gap in emerging mobile health literature; while technology is rapidly advancing to monitor the complex nature of AUD, mobile health interventions are not currently incorporating these abilities into treatments for AUD. Nahum-Shami and peers suggest utilization of JITAIS via an "intervention-determined" approach, where individuals are monitored for decision rules where certain treatment techniques should be applied. This approach easily lends itself to incorporation of the AUD complexity discussed in contemporary relapse prevention models, where the proximal and distal factors leading up to a lapse in recovery are essential to tailoring the content and timing of specific interventions. <!--GEF: similarly, i think this paragraph can be shortened in combination with the previous paragraph to get across the two main points (which are basically your two topic sentences) -->
...
<!--JJC: this still keeps the focus on JITAIs.  Need to keep focus on prediction algorithms.--> 
...
## Current project
The current project can address treatment barriers <!--GEF: I'd vote for an alternative, narrower framing of the purpose of the current project. it's about learning whether we can predict lapses prospectively using EMA data - about whether we can monitor patients' risk rather than asking them to self-monitor. addressing treatment barriers feels pretty big -->
<!--JJC: Agree with GEF here-->
...
<!--GEF: highlight that these are improvements designed to address limitations of existing, promising research using ML for SUD outcomes -->
