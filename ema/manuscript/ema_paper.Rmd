...
```{r fig.cap = fig_caption_consort, out.extra = "", fig.pos="ht", fig.width=10, fig.height=8}
...
```{r fig.cap = fig_caption_auc, out.extra = "", fig.pos="ht"}
...
```{r fig.cap = fig_caption_pp, out.extra = "", fig.pos="ht"}
...
```{r fig.cap = fig_caption_pr, out.extra = "", fig.pos="ht"}
pr_all %>% 
...
```{r fig.cap = fig_caption_shapgrouped_1week, out.extra = "", fig.pos="ht"}
shap_grouped_week %>% 
...
```{r fig.cap = fig_caption_shapgrouped_1day, out.extra = "", fig.pos="ht"}
shap_grouped_day %>% 
  mutate(group = factor(group),
         group = forcats::fct_inorder(group)) %>% 
  ggplot(mapping = aes(x = group, y = mean_value)) +
...
```{r fig.cap = fig_caption_shapgrouped_1hour, out.extra = "", fig.pos="ht"}
shap_grouped_hour %>% 
  mutate(group = factor(group),
         group = forcats::fct_inorder(group)) %>% 
  ggplot(mapping = aes(x = group, y = mean_value)) +
...
```{r fig.cap = fig_caption_hist_1week, out.extra = "", fig.pos="ht"}
preds_week %>% 
...
```{r fig.cap = fig_caption_hist_1day, out.extra = "", fig.pos="ht"}
preds_day %>% 
  mutate(truth = if_else(truth == "no_lapse", "No lapse", "Lapse"),
         estimate = if_else(estimate == "no_lapse", "No lapse", "Lapse")) %>% 
  ggplot(data = ., aes(x = prob)) + 
...
```{r fig.cap = fig_caption_hist_1hour, out.extra = "", fig.pos="ht"}
preds_hour %>% 
  mutate(truth = if_else(truth == "no_lapse", "No lapse", "Lapse"),
         estimate = if_else(estimate == "no_lapse", "No lapse", "Lapse")) %>% 
  ggplot(data = ., aes(x = prob)) + 
...
```{r fig.cap = fig_caption_shapraw_1week, out.extra = "", fig.pos="ht"}
shap_raw_week %>% 
  slice_tail(n = 50) %>%
...
```{r fig.cap = fig_caption_shapraw_1day, out.extra = "", fig.pos="ht"}
shap_raw_day %>% 
  slice_tail(n = 50) %>%
  mutate(variable = factor(variable),
         variable = forcats::fct_inorder(variable)) %>% 
...
```{r fig.cap = fig_caption_shapraw_1hour, out.extra = "", fig.pos="ht"}
shap_raw_hour %>% 
  slice_tail(n = 50) %>%
  mutate(variable = factor(variable),
         variable = forcats::fct_inorder(variable)) %>% 
