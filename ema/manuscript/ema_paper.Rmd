...
footnote_table_auh_b <- "Two participants reported 100 or more lapses. We removed these outliers prior to calculating the mean (M), standard deviation (SD), and range."
```
