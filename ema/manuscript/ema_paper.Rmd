...
```{r}
disposition <- vroom(here(path_data_ema, "disposition.csv"), col_types = "ccDDcccccccccc")
screen <- vroom(here(path_data_shared, "screen.csv"), col_types = vroom::cols()) %>% 
...
<!--JOHN: I added this alcohol history table too. We can consider joining it with demographics. It was separate for burden paper.-->
