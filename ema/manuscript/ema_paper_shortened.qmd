...
<!-- GEF: word count with the shortened versions of the paragraphs at the end of the section would be 2278. i'm sure we could still shorten a bit from there -->
...
<!-- GEF: personally i think it fits well here, but i'm sure it could work either way!-->
...
<!-- GEF: i agree with this idea generally, though i actually moved the first ppv paragraph up to the model performance section and edited. if you feel it should go earlier within clinical implementation instead, that works too! i just edited it to be more about the model performance component of PPV rather than how that affects clinical implementation specifically, since we cover that well in this subsequent paragraph.

i then tailored the second paragraph here-->
