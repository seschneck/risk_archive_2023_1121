...
shap_local_week <- read_rds(file.path(path_models, "imp_shap_grouped_all_1week_0_v4.rds")) 
shap_local_day <- read_rds(file.path(path_models, "imp_shap_grouped_all_1day_0_v4.rds"))
shap_local_hour <- read_rds(file.path(path_models, "imp_shap_grouped_all_1hour_0_v4.rds")) 
...
<!--JJC HERE line width and mean/median-->
