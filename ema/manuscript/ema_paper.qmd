...
## EMA compliance, features (predictors), and lapse labels (outcome)

We used reports from participants' 4x daily EMAs to create datasets of features and lapse labels to develop and evaluate three separate classification models to predict future lapses the next week, the next day, and the next hour, respectively.  EMA compliance over the study was generally good, with participants completing an average of 3.1 (sd = 0.6) of the 4 daily reports per day or 78% compliance overall.  Participants completed at least 1 EMA report on 95% of days.  Across weeks in the study, the compliance percentages ranged from 75% - 87% for 4x daily and from 92% - 99% for at least 1 daily EMA.  Figure <!--insert number--> displays compliance percentages over time (by week).    
