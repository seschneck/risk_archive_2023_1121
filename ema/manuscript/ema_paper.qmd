...
A final piece that effects all three forms of clinical implementation is PPV. 
...
Another future direction for research on clinical implementation of a recommendation algorithm is to understand the best way to provide recommendations as feedback. Two key components are transparency of the algorithm-guided recommendation and communication style. <!-- add language from messaging grant -->
