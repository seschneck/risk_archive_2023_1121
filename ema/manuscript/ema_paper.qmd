...
Other possible future directions: <!-- GEF: not writing these out yet as I don't know if we want to include them -->
  ...
  * Another future direction for research on clinical implementation of a recommendation algorithm is to understand the best way to provide recommendations as feedback. Consider: algorithmic transparency, communication factors from messaging grant?
