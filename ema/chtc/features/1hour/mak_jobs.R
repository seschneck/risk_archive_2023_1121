...
file.copy(from = here("ema", "chtc", "features", "1hour", "unix", c(list.files(here("ema", "chtc", "features", "1hour", "unix")))),
          to = here(path_jobs, name_job, "input"),
          recursive = TRUE)

# copy R script
file.copy(from = here("ema", "chtc", "features", "1hour", name_script),
