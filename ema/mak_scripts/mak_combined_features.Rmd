---
title: "Aggregates jobs for EMA features from CHTC"
author: "John Curtin"
...
switch (Sys.info()[['sysname']],
        # PC paths
        Windows = {
          path_jobs <- str_c("P:/studydata/risk/chtc/ema/features_", window)
          path_ema <- "P:/studydata/risk/data_processed/ema"},

        # IOS paths
        Darwin = {
          path_jobs <- str_c("/Volumes/private/studydata/risk/chtc/ema/features_", window)
...
```{r}
features %>% 
  vroom_write(here(path_ema, str_c("features_", window, ".csv"))) %>% 
  vroom_write(here(path_ema, str_c("features_", window, ".csv.xz")))
```
