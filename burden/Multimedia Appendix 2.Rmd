...
ema_week_compliance %>% 
  ...
  scale_y_continuous(name = "Compliance", 
                     breaks = seq(0, 1, .1), 
                     limits = c(0, 1)) +
  labs(title = "Figure S1 <br><br>4x Daily EMA compliance over time for participants who completed the study",
...
Below we plot compliance with at least one daily EMA over time for participants who completed the study (Figure S2 from the manuscript). A t-test revealed that participants who did not complete the study on average had significantly lower compliance (M = .87, SD = .14) compared to participants who completed the study (M = .96, SD = .08), t(152) = -4.1, p < .001.
...
ema_1_week_compliance %>%
  ...
  scale_y_continuous(name = "Compliance",
                     breaks = seq(0, 1, .1),
                     limits = c(0, 1)) +
  labs(title = "Figure S2 <br><br>1x Daily EMA compliance over time for participants who completed the study",
...
audio_week_compliance %>% 
  ...
  scale_y_continuous(name = "Compliance", 
                     breaks = seq(0, 1, .1), 
                     limits = c(0, 1)) +
  labs(title = "Figure S3 <br><br>Daily audio check-in compliance over time for participants who completed the study",
...
p_wrist +
 plot_annotation(
   title = "Figure S4<br><br> Physiology Acceptability",
...
The figure below is Figure S5 from the manuscript. We examined acceptability ratings over time for participants who completed the study through follow-up 3 (N = 133). We see average acceptability ratings for each personal sensing data stream are relatively stable across time.   
...
time_plot %>% 
  ...
  scale_y_continuous(name = "Mean Score", 
                     breaks = c(-2, -1, 0, 1, 2), 
                     limits = c(-2, 2)) +
  labs(title = "Figure S5<br><br>Acceptability over Time by Personal Sensing Data Stream",
