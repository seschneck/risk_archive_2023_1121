...
<!--
Proposed changes to ms:

"More recently, research using personal sensing of raw data streams other than self-report is emerging for mental health broadly, including alcohol and other substance use disorders. This includes methods to sense geolocation [13–15,30-32], cellular communications [15–19,29-32], sleep [19], and physiology [20,21,29-32,35], as examples." 

"For alcohol and other substance use disorders, research is emerging now to used sensed data to predict craving [13,35], alcohol [29-31,33], cannabis [32], or opioid use [15], and lapses/relapse [15,34,36]."-->
...
----
We have broken up the references to be more clear about which are related to alcohol specifically (29-31, 33). See point RO.4 above.  We have not opted to further expand the review of the literature in the introduction as the editor has already noted that our paper is longer than typical for this journal.  This goal of the introduction was simply to provide a framework for the study; this paper is not intended to be a stand-alone review.
<!--no changes needed to ms-->
...
We will keep these issues salient as we continue this work and future studies will probe more careflly for negative experiences associates with frequent sampling. 
<!-- No change to ms needed-->
...
----
We now mention this as a limitation in the Limitations and Future Directions section of the Discussion.
...
<!-- Proposed change to ms - parenthetical clarification enough?:
...
We bring attention again to the need for further testing in applied settings in our Limitations and Future Directions section of the Discussion.    
