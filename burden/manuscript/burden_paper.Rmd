...
Findings have been inconsistent regarding the relative impact of assessment burden on acceptability as EMA protocols require more active effort from participants due to increases in density (frequency of surveys) or depth (number of items/length of surveys)[REF<!--cite king preprint ; https://psyarxiv.com/chszq/-->.  Increased density does not appear to robustly impact perceptions or compliance [@eiseleEffectsSamplingFrequency2020; @stoneIntensiveMomentaryReporting2003; @jonesComplianceEcologicalMomentary2019; but see @wenComplianceMobileEcological2017].  However, greater survey depth may decrease both perceptions of acceptability and compliance  [@eiseleEffectsSamplingFrequency2020].  Notably, these studies were again generally limited to shorter duration monitoring periods (i.e, <= 6 weeks)
...
Cornelia Wrzus, Andreas B. NeubauerFirst Published January 11, 
...
```
KENDRA
This is from wrzusEcologicalMomentaryAssessment2022 RE density and duration

In most previous studies, the compliance rate (i.e., percentage of answered assessments from all scheduled assessments) did not differ with the number of assessments per
day (Jones et al., 2019; Ottenstein & Werner, 2021; Rintala
et al., 2019; Vachon et al., 2019). Studies that experimentally varied the number of assessments per day demonstrated likewise that compliance for 14 days was comparable
when answering 3, 6, 9, or 12 prompts per day (Eisele et al.,
2020; Stone et al., 2003). In contrast, as assessment days
increased within studies, typically for more than 1 week,
participation often became burdensome and compliance
declined over time (Ono et al., 2019; Rintala et al., 2019;
Silvia et al., 2013). Accordingly, some studies schedule
break days without assessments in between assessment
days to maintain motivation and thus compliance for longer
periods (e.g., Neubauer et al., 2018; Riediger et al., 2009).
<!-- INSERT PARAGRAPH ABOUT DURATION.   Can highight again that not many long duration studies.   Also, longer studies dont often look at compliance or perceptions by time.   And then note that there are a couple/few examples of compliance or drop out over time.  This assumes that there is not a clear conclusion about duration from meta analyses. If there is, lets report that instead.-->

Existing research also raises some concern about relative perceptions and compliance with EMA protocols in clinical vs. healthy samples.  For example, patients with current affective disorders reported increased momentary perceptions of burden while completing EMA surveys relative to patients in remission and healthy controls [@vangenugtenExperiencedBurdenAdherence2020].  However, no differences in compliance or retrospective perceptions of burden were observed across the three groups.  In contrast, a recent meta-analysis confirmed decreased compliance with EMA protocols in patients with substance use disorder diagnoses vs. recreational substance users [@jonesComplianceEcologicalMomentary2019]<!-- Kendra can you confirm the analyses of study duration in this meta analysis.   I'd like to cite the other study you mention below about drop off but not if this meta analysis looks at longer studies and finds nothing.-->
