...
```{r}
fig_caption_2 <- "Compliance over Time for EMA (1x daily), EMA (4x daily), and Audio Check-in.\\linebreak Notes:  Mean compliance for each week on study. Overall mean compliance is depicted by the dashed line. N = 154."
```
