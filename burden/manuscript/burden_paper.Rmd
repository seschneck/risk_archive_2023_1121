...
Unfortunately, overall participant compliance with this active sensing method was relatively low (55% of daily check-ins completed) and 2% of the sample did not complete any check-ins throughout their entire study period. That said, more nuanced consideration compliance across participants suggested a somewhat bi-modal distirbution with many participants displaying high compliance (> 80%) but many others  of the distribution for compliance suggested that .....   Participants' free-response evaluation of this method revealed  of T   
...
* incentives not matched to real-world implementation (but could do contingency management for these data if valuable) and on other hand, there were few benefits other than payment in this study
