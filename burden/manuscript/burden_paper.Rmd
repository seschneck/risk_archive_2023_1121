...
the total number of scheduled assessments
...
and compliance: Compliance was lower with more assessments
...
compliance rates did not differ between healthy, physically ill, mentally ill, and mixed samples 
...
data_willingness_long %>% 
  ...
  geom_vline(aes(xintercept = 0), linetype = "dashed", size = .4, color = "#787575")
```
>>>>>>> d87a94668fe45f66a851f0db3cc87ece6cd86cf2
