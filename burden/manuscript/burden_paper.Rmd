...
notes_incomplete %>% 
  ...
  kable_styling() %>%
  row_spec(row = 0, align = "c", italic = TRUE) %>%
  add_header_above(c("Characterization of eligible and consented participants who discontinued prior to completing enrollment" = 3), align = "l", bold = FALSE) %>% 
  add_header_above(c("A" = 3), align = "l", bold = FALSE) %>%
...
notes_incomplete %>% 
  ...
  kable_styling() %>%
  row_spec(row = 0, align = "c", italic = TRUE) %>%
  add_header_above(c("Characterization of enrolled participants who discontinued prior to first month follow-up" = 3), align = "l", bold = FALSE) %>% 
  add_header_above(c("B" = 3), align = "l", bold = FALSE) %>% 
...
notes_incomplete %>% 
  ...
  kable_styling() %>%
  row_spec(row = 0, align = "c", italic = TRUE) %>%
  add_header_above(c("Characterization of enrolled participants who discontinued after the first month follow-up" = 3), align = "l", bold = FALSE) %>% 
  add_header_above(c("C" = 3), align = "l", bold = FALSE) %>% 
