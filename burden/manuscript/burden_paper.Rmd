...
<!-- FIX: Need to generate this figure by code-->
<!-- FIX: I can't get text references to work.  This hacky solution works as long as we don't need special formating
...
<!-- Denominator for above percentages is 192-->
...
<!-- Review/update (by code) number of decimal places for self report measures.   One should be appropriate.  
