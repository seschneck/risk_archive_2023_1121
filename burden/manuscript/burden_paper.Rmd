...
- Used in research already.  
    - EMA 
    - Sometimes gives access to “information” that can not be reported by participant easily
...
Personal sensing methods have already made important contributions to research on psychiatric disorders.  Ecological momentary assessments (EMA), which collect brief self-reports about momentary states multiple times per day, have been used for many years in short-term longitudinal studies.  

Proof of concept with healthy controls or small samples of with convenience samp

These measures are already being used for research social anxiety [4], depression [5--10], bipolar disorder [11--13], schizophrenia [14--17], and substance use [18--22], and from these signals.

is emerging as potentially powerful method gaining popularity in the field of clinical psychology where early detection of and monitoring for mental health symptoms enables treatment and intervention [1,3].
