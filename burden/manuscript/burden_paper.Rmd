...
We collected the study data between 2017 -- 2019 as part of a larger grant-funded parent project (R01 AA024391). This study represents secondary data analyses of those data.  The sample size was determined based on power analyses for the aims of that project. We used all available participants for this study. 
