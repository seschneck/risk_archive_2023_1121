...
the total number of scheduled assessments (assessments per day X total days) was unrelated to compliance,
b = .008, p = .714, r = .021, and dropout, b = −.002, p
= .928, r = −.009. 

Unregistered analyses suggested a quadratic
association between the number of assessments per day
and compliance (blinear = −.682, p = .055, bquadratic = .103,
p = .034): Compliance was lower with more assessments
per day, and this effect flattened with more assessments. 

We did not expect compliance rates to vary with the health status of EMA participants per se, and explorative analyses showed that
compliance rates did not differ between healthy, physically ill, mentally ill, and mixed samples, F(3, 336) =
2.02, p = .111, η² = .018. 

They did not look only at days (independent of number of assessments)
```
