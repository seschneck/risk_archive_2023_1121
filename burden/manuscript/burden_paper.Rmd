...
<!-- @Kendra re: fig placement: use fig.pos and also out.extra="" in chunk options.-->
<!-- @Kendra re: fig.caption: figure names cannot have spaces or underscores, I replaced them with hyphens.-->


<!-- @Kendra re: line breaks in figure captions: use \\linebreak and see the added usepackage{caption} where it specifies allowing ragged right margin-->
