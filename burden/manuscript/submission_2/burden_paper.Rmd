...
In addition to trust, setting may also affect perceived benefits of sensing methods. For example, individuals in active treatment for alcohol use disorder may find these methods more acceptable (e.g., as an adjunct to their existing treatment) than those not in treatment. <!--RB.5-->
