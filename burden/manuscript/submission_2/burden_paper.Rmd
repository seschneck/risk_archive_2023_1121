...
This study represents secondary data analyses of participants recruited for a larger grant-funded parent project (R01 AA024391) [@RePORTRePORTERa]. 

The goals of this project are to develop and deliver a dynamic, real-time model for forecasting alcohol use lapse among abstinent alcoholics. This lapse risk prediction model will be integrated into an existing validated mHealth platform to encourage sustained recovery through adaptive use of continuing care services
...
<!--benefits may differ-->
<!--RO.2 - acknowledge participants may have been motivated by clinical benefit-->
