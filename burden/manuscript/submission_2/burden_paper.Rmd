...
@kleimanUsingWearablePhysiological2019 - adolescent suicidal inpatients
...
Incentives may be less necessary in clinical settings when more direct clinical benefits from personal sensing are available.  For example, research has suggested that privacy concerns associated with personal sensing may be reduced if participants perceive that they will benefit from the sensed data [@atienzaConsumerAttitudesPerceptions2015; @klasnjaExploringPrivacyConcerns2009; @bessenyeiComfortabilityPassiveCollection2021]. There was some evidence for this perspective in the free response comments from our participants as well.  
