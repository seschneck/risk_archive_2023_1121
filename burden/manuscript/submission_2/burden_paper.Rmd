...
While our results suggest clinical samples of people with alcohol use disorder may find these personal sensing measures acceptable, more research is needed to test these measures in different settings. As described earlier in our discussion, the research setting comes with built-in protections for the participant. Although clinical settings may also come with protections (e.g., HIPPA compliance, FDA-approved digital therapeutics) it is possible these affect trust differently. <!--RO.26--> In addition to trust, setting may also affect perceived benefits of sensing methods. For example, individuals in active treatment for alcohol use disorder may find these methods more acceptable (e.g., as an adjunct to their existing treatment) than those not in treatment. <!--RB.5-->
