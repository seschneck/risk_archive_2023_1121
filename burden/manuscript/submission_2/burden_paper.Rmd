...
Existing research also raises some concern about perceptions and adherence to EMA protocols in patients with SUD relative to other groups.  Specifically, a recent meta-analysis confirmed decreased adherence to EMA protocols in patients with SUD diagnoses vs. recreational substance users  [@jonesComplianceEcologicalMomentary2019].  However,  another meta-analysis [@wrzusEcologicalMomentaryAssessment2022] showed that adherence rates did not differ between healthy, physically ill, mentally ill, and mixed samples, which suggests that adherence concerns may be limited to applications with patients with SUD rather than all psychiatric disorders more generally.
