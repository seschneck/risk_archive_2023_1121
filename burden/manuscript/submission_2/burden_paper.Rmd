...
### Data Source 
This study represents secondary data analyses of participants recruited for a larger grant-funded parent project (R01 AA024391). 
https://reporter.nih.gov/search/LLKWYWhN9EO5FmeFLrTL5g/project-details/8986398
...
While our results suggest clinical samples of people with alcohol use disorder may find these personal sensing measures acceptable, more research is needed to test these measures in different settings. As described earlier in our discussion, the research setting comes with built-in protections for the participant. Although clinical settings may also come with protections (e.g., HIPPA compliance, FDA-approved digital therapeutics) it is possible these affect trust differently. <!--RO.26--> 
<!--expand-->
