...
Tell us your general thoughts, whether positive or negative, about your experience completing [Personal sensing method name].

<!-- Frame as a way of assessing acceptability or keep vague as just feedback on experiences with each measure? -->

<!-- Mention in data analytic strategy section?-->
...
auh %>% 
  ...
  pack_rows("Types of Lifetime Treatment (Can choose more than 1)", 6, 12, bold = FALSE) %>%
