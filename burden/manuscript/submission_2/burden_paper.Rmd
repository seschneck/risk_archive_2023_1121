...
In addition to trust, setting may also affect perceived benefits of sensing methods. For example, individuals in active treatment for alcohol use disorder may find these methods more acceptable (e.g., as an adjunct to their existing treatment) than those not in treatment or those who do not meet the threshold for alcohol use disorder. <!--RB.5-->

Our study conclusions are limited to a three-month period. While many studies suggest the novelty period lasts 2 -- 4 weeks [<!--cite-->], one study suggests it could be as long as 3 months [@shinNoveltyEffectMixedmethods2018]. It is important for future studies to extend study length to account for these effects. <!--mention RISK2?--> <!--RK.3-->
