...
## AE.3: Consider reformatting Fig 1. into a more traditional CONSORT diagram: https://www.consort-statement.org/consort-statement/flow-diagram
...
We have added review and discussion in the Introduction of numerous additional sensing studies that have been used to predict AUD/SUD relevant outcomes including alcohol, cannabis, and opioid use, lapse/relapse, and craving.  These studies focus both on active measures like EMA but also demonstrate the potential utility of passive measures with a focus on geolocation and cellular communications as reviewed in this study.  
<!--CD--><!--MD-->
...
We now acknowledge the large number of missing information as to why participants did not enroll as a limitation of our study in the Limitations and Future Directions section of the Discussion. 
<!--CD--><!--MD-->
...
We now acknowledge our inability for formal measures of compliance on our passive sensing methods as a limitation of our study (see Limitations and Future Directions section). We also clarify how we differentiate between opting-in and compliance in the Methods section. Specifically, opting-in indicates participants were willing to provide us any data. This measure is available for both our active and passive sensing methods.  It should be noted that although it is possible for participants to delete individual messages and to turn off tracking, the data do not suggest this was widespread.  Participants provided geolocation data only almost all days across the sample and text and phone message logs contained many, many responses.  
<!--CD--><!--MD-->
...
We have now moved the qualitative data from the discussion as noted earlier (see AE.4).  Previously, we had commented on limitations throughout the discussion section. We have now re-organized the discussion to include a primary "Limitations and Future Directions" section to make the acknowledged limitations more salient.  In addition, we also now include additional limitations based on reviewer critiques that were not previously acknowledged.  
<!--CD--><!--MD-->
...
We now discuss the impact the wording of our acceptability questions might have on participant responses in the Limitations and Future Directions section. Specifically, we acknowledge that asking participants if they would be willing to use a personal sensing method for 1 year to help with their recovery could imply there would be clinical benefit to using the method for 1 year. Such a perceived benefit may factor into their judgment of acceptability.  However, it we have also now made clear in the manuscript (and supporting materials on OSF) that participants were informed at multiple points in the onboarding process that there were no benefits to them provided from sensing other than financial compensation.  They did not receive any feedback from the sensed data.  They were not provided tailored interventions based on the sensed data.
<!--CD--><!--MD-->
...
We now cite this paper in our discussion (see Limitations and Future Directions section). We acknowledge that while three months duration is an improvement to current studies on acceptability of personal sensing, it still may not be long enough to account for novelty effects.  In fact, we are now conducting another study that uses sensing methods for up to one year with participants in recovery from SUD.  We cite the published study protocol for that project as an important future direction.
<!--CD--><!--MD-->
...
Unfortunately, we are unable to see if and how often people disabled their locations or deleted phone calls and text messages. We agree this is a limitation of our study and we now acknowledge it in our Limitations and Future Directions section of the Discussion. It should be acknowledged that many of the sensed features are not limited to obvious risky locations like bars.  Instead, we can sense time spent in treatment settings, time spent out of the home, time spent in homes of supportive others, time spent in settings that are self-described as rewarding.  Preliminary research with these features suggest they have high predictive value in lapse prediction algorithms and it is arguably less likely that participants/patients would censor these locations.
<!--CD--><!--MD-->
...
Personal sensing is being used with psychiatric samples generally and samples with alcohol and other substance use disorders.  Meta-analyses have suggested that sensing is less acceptable to patients with substance use disorders but not other mental illness.  We cite these meta-analyses as part of the rationale to look at acceptability in more detail in our sample with alcohol use disorder.   We have clarified this rationale further in the introduction.
<!--CD--><!--MD-->
...
We now acknowledge that these questions have not been used or tested in other research settings and the potential for biased responses in our Limitations and Future Directions section of the Discussion. Of course, it should be acknowledged that our analyses and conclusions regarding acceptability were not based only on the self-report measures but also on object participant behaviors as well. 
<!--CD--><!--MD-->
...
We have edited the description in the Method of the self-report questions posed to participants and directly shared the measure on the OSF study page.  In fact, the participants were asked to "indicate how much you agree or disagree with each statement" on a 5-point bipolar scale (strongly disagree, disagree, undecided, agree, strongly agree).  It is true that the framing of these statements was intended to detect burden, which is why they focused on dislike, interference, and willingness to use for a year.  We did not expect that people would necessary like or otherwise experience enjoyment from sensing methods.  They are not intended for that purpose.  However, if they were burdensome, it may be that people would not use them even if they provided benefits in their use in later clinical applications.  Nonetheless, as acknowledged elsewhere (see RO.16), we recognize that the use of novel measures that we created for this study is a limitation and report it as such in the Future Directions and Limitations section of the Discussion.   
<!--CD--><!--MD-->
...
We do not believe that the data suggest problems with the self-report measures.   Although the means for methods across the sample are similar, those means are, in fact, statistically different from each other in many instances (see pairwise comparisons among methods in Table S1 in Multimedia Appendix 3).  In addition, the histograms of individual responding demonstrate that participants used the full range of all of the measures across the sample.  Furthermore, significant correlations among measures (reported in the analyses) would be possible to detect if there was systematic variance across participants in their scores on these measures.  Nonetheless, we do now acknowledge that the use of novel (previously unvalidated) measures of acceptability is a limitation of this study.  That said, we are  not aware of previously validated measures of acceptability that could have been used instead as this is an emerging area of research.
<!--CD--><!--MD-->
...
We have moved this table from the Results to Table S3 in Multimedia Appendix 3 to somewhat de-emphasize this information.  To be clear, Table S3 did not suggest that unbolded categories were not about acceptability.  Instead, they were simply not highlighted as clearly related to acceptability vs. other clearer categories (e.g., non-compliance with providing data, city study demands as burdensome, no longer interested).  Patients with SUD often relapse such that it is not unexpected that many participants would discontinue because they no longer wanted to stay sober.  Participants counted as multiple reschedules are participants that did repeatedly try to come to study visits (they recontacted us after missed or re-scheduled appointments).  If they found the sensing methods unacceptable it seems unlikely that they would not simply not reschedule with us after a missed visit.  Nonetheless, we have updated the table note to more clearly indicate that bolded entries are clearly related to acceptability but no entries could be definitively designated as unrelated to acceptability.  
<!--CD--><!--MD-->
...
## RO.25: The qualitative data in the form of statements from participants on their experience is interesting. How were they collected and analyzed? Why are they not presented as results?
