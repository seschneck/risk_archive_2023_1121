...
<!--CD--><!--Kendra, confirm this has been done.-->

<!--John, confirming this has been done-->
...
We have moved the qualitative data from the Discussion to either Table 7 in the Results section or  Tables S3-S7 in the Supplemental materials.
<!--CD--><!--Kendra, can you update table 7 to color the comments green or red to indicate if they were positive or negative.  You can leave them black if they were neither or both.--> <!--JC review again-->

<!--John, these changes have been made and the manuscript re-knitted-->
...
<!--Kendra, this doesnt fully address the question of opting in/out multiple times.  Lets talk to Susan on Monday about this.  We should also add an answer to the question here since its brief.  But we need a full answer first.-->
...
We now clarify in the methods that we compensated participants for all sensing methods.  We paid participants monthly bonuses for each method if they had 10% or less missing data for that method.  The magnitude of those bonsuses varied.....  These details are described in the Compensation section of the Method.
...
<!--CD--><!--Kendra, did you remove it?-->

<!--John, yes this is removed-->
...
We have uploaded a copy of our recruitment flyer that was posted at various in-person and digital community locations, such as AA meetings, Metro buses, UW hospitals and clinics, Facebook, Craigslist, and UW Health AppSpace screens, to our OSF page (https://osf.io/2pcjb). 
<!--Kendra, what participant info are they referring to?-->

<!--John, I believe they are referring to the information participants received about the study. I uploaded a recruitment flyer to OSF. Should I add anything else? Informed consent form?-->
...
No, we added the following sentence to the Methods section to clarify this. "Participants were not informed how these sensing methods might be connected to their alcohol use, only that we were collecting data with the goal to create a mobile technology-based resource to monitor relapse risk."
...
Types of Treatment in Table 2 refer to lifetime treatments. We now make this more clear by using the label Types of Lifetime Treatment in the table.

<!--Kendra, I am not clear on what you mean here-->
<!--John, I updated this response for you to re-review-->
...
<!--CD--><!--JJC will edit method section-->
