...
Unfortunately we are unable to see if and how often people disabled their locations or deleted phone calls and text messages. We agree this is a limitation of our study and we now acknowledge it in our Limitations and Future Directions section of the Discussion. It should be acknowledged that many of the sensed features are not limited to obvious riskly locations like bars.  Instead, we can sense time spent in treatment settings, time spent out of the home, time spent in homes of supportive others, time spent in settings that are self-described as rewarding.  Prelimiary research with these features suggest they have high predictive value in lapse prediction algorithms and it is argubably less likely that participants/patients would censure these locations.
<!--CD--><!--MD-->
