...
Below we plot the total compliance with EMA (4 prompts per day), EMA (1 prompt per day), and the daily audio check-in over time for participants who completed the study (Figure S3 from the manuscript). 
...
week_compliance_all %>% 
  ...
  labs(title = "Figure S3 <br><br>1X Daily EMA, 4x daily EMA, and audio check-in compliance over time for participants who completed the study",
       caption = "<i>Note:</i>  Average compliance by week for participants who completed the full 3-month study (N = 133). <br>Dashed line represents overall mean compliance.") +
  theme(legend.title = element_blank(),
        legend.text = element_markdown(),
...
plot_audio_fu1 +
 plot_annotation(
  title = "Figure S4<br><br>Audio Compliance by Participant",
...
Participants reported on their willingness to continue an EMA method that was one time daily for one year. This method was hypothetical in that although they were asked about a one time daily EMA they were expected to do four daily EMAs. Below is the distribution of responses for this question (Figure S5 from the manuscript).   
...
plot_ema_1x +
 plot_annotation(
  title = "Figure S5<br><br>Willingness to Complete a Once Daily Ecological Momentary Assessment for One Year",
...
We obtained participant's free-response comments for each personal sensing method as a qualitative index of acceptability. Below are the raw participant responses for each method (Supplemental tables 3-7 in manuscript).
