...
Study start or end dates were also adjusted to accommodate large gaps in GPS data  See details in 
mak_gps_enriched.Rmd.  These adjustments were made to

* 80, 74, 84, 65, 117, 19, 42, 167, 207, 28, 218, 39, 214, 47, 203, 40, 76, 78, 161, 180, 169, 34, 265, 30, 63, 178

Finally, 5 participants were dropped b/c of very high levels (>= 50%) missing GPS
...
```{r}
dates %>% 
  write_csv(here(path_gps, "study_dates.csv")) %>% 
  glimpse()
```
