...
```{r}
labels_1_hour %>% 
  write_csv(here(path_gps, "labels_1hour.csv")) %>% 
  write_csv(here(path_gps, "labels_1hour.csv.xz"))

labels_1_day %>% 
  write_csv(here(path_gps, "labels_1day.csv")) %>% 
  write_csv(here(path_gps, "labels_1day.csv.xz"))

labels_1_week %>% 
  write_csv(here(path_gps, "labels_1week.csv")) %>% 
  write_csv(here(path_gps, "labels_1week.csv.xz"))
```