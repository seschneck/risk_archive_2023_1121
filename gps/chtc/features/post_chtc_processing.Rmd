...
```{r}
err_files <- future_map_df(list.files(here(path_jobs, "output", "error"), 
                               full.names = TRUE), 
                    file.info)
n_err_files <- nrow(err_files)
# out_files <- future_map_df(list.files(here(path_jobs, "output", "out"), 
#                                full.names = TRUE), 
#                     file.info)
# n_out_files <- nrow(out_files)

feature_files <- future_map_df(list.files(here(path_jobs, "output", "features"), 
                               full.names = TRUE), 
                    file.info)
